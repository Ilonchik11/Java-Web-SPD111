...
@Singleton
public class HybridAddItemParser implements AddItemParseService {
    ...
    @Override
    public AddItemParseResult parse(HttpServletRequest request) {
